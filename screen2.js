const messageQueue = [
  `Chúc hai ngày 20/10 luôn xinh đẹp như hoa, rạng rỡ như nắng và ngọt ngào như mật. Happy Women's Day!!!!`,
  `Chúc tất cả chị em không chỉ có 1 ngày 20/10 mà mỗi ngày đều vui vẻ, trẻ trung, xinh đẹp nhé!`,
  `Chúc các chị/em có một ngày 20/10 thật ý nghĩa, được mọi người yêu thương, tiền đầy túi, tình đầy tim.
    Happy Women's Day`,
  ...
  `Chúc các chị em thật vui vẻ và rạng rỡ trong ngày 20/10
  ...
  `Chúc các chị em phụ nữ có một ngày 20/10 thật ý nghĩa và hạnh phúc bên gia đình và bạn bè của mình nhé.`,
  `Gửi lời chúc riêng đến các chị em bạn bè mãi tươi trẻ và nhiệt huyết <3`,
  `Chúc hai một ngày 20/10 vui vẻ, luôn vui tươi, xinh đẹp và yêu đời như mọi ngày. Mặc kệ những lời đàm tiếu xung quanh, vì em đẹp nhất khi là chính em.`,
];
